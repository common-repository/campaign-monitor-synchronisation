...
Version: 1.0.9
Description: Caution, the plugin repository has been renamed. You need to de-install this plugin, remove the files and install the plugin 'campaign-monitor-synchronization'. This version will no longer be updated.
